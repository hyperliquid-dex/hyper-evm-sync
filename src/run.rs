    ...
    <S as Database>::Error: std::fmt::Debug,
{
    ...
    if block.number == WRITE_PRECOMPILE_INSERTION_BLOCK_NUMBER {
        deploy_system_contract(state, WRITE_PRECOMPILE_ADDRESS, bytes!(""));
    }
...
const WRITE_PRECOMPILE_ADDRESS: Address = address!("0x3333333333333333333333333333333333333333");
...
const WRITE_PRECOMPILE_INSERTION_BLOCK_NUMBER: u64 = 7_578_299;
